...
class ConfigServicesNode(Node):
    ...
    def _on_list_configs(
        self,
        _req: ListConfigs.Request,
        res: ListConfigs.Response,
    ...
    def _on_activate_config(
        self,
        req: ActivateConfig.Request,
        res: ActivateConfig.Response,
    ...
    def _on_delete_config(
        self,
        req: DeleteConfig.Request,
        res: DeleteConfig.Response,
